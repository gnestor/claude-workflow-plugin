...
|--------------|--------|----------|
| Error/failure with solution | Add fix to skill's SKILL.md | `skills/<skill>/` |
| New usage pattern | Document in references | `skills/<skill>/references/` |
| New company context | Add to relevant reference file | `skills/company/references/` |

**Company reference files:** overview, team, goals, products

**Important:** Ensure all skill revisions comply with skill guidelines:
- SKILL.md should stay concise and focused
- Split content into reference files when SKILL.md gets too long
...
- Add fix to relevant skill or reference file

**For usage patterns:**
- Add to `references/workflow-examples.md` with example prompts and steps

**For company context:**
- Add to the relevant reference file in `skills/company/references/`
