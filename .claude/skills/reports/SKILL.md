---
name: reports
description: Guidelines for creating analysis reports, including templates, structure, and best practices. Use when generating reports, summaries, or data analysis documents.
---
...
1. **Gather data** using appropriate skill (klaviyo, shopify, etc.)
2. **Analyze** using Task agents or manual review
3. **Document** using this reports skill
4. **Store** in `reports/` directory
5. **Reference** in AGENTS.md or department files if findings are reusable
